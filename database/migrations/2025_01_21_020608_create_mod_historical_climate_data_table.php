...
return new class extends Migration
{
    ...
    {
        Schema::create('mod_historical_climate_data', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('location_id'); // Fremdschlüssel zur Location
            $table->year('year'); // Jahr der Zusammenfassung
            $table->string('month')->nullable(); // Monat oder null für jährliche Daten
    ...
    {
        Schema::dropIfExists('mod_historical_climate_data');
    }
};
