<div>
    ...
    <div class="modal modal-blur fade show" style="display: block;" tabindex="-1" role="dialog" wire:ignore.self>
        <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
            <div class="modal-content">
                <!-- Modal-Header mit dunklem Hintergrund und weißem Text -->
                <div class="modal-header bg-primary-800 border-bottom-0">
                    <h5 class="modal-title fw-bold text-white">
                        Standort bearbeiten: {{ $location && $location->title ? $location->title : 'Unbekannter Standort' }}
                    </h5>
                    <button type="button" class="fs-5 border-0 bg-transparent text-white" wire:click="closeModal" aria-label="Close">
                ...
                <!-- Modal-Footer mit angepasstem Styling -->
                <div class="modal-footer border-top-0">
                    <button class="btn btn-light-secondary" wire:click="closeModal">Schließen</button>
                    <!-- Optional: Speichern-Button hinzufügen, falls gewünscht -->
                    <!-- <button class="btn btn-light-primary" wire:click="saveChanges">Speichern</button> -->
                </div>
            </div>
        </div>
    </div>
