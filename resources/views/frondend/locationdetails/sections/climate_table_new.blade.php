    ...
    <div class="container" style="background-color: #eaeff5; border-radius: 8px; padding: 20px;">
        <div class="row">
            ...
            <div class="experience-info col-lg-3 col-sm-5 bg-info p-3 rounded-start weather-box">
                ...
                <div class="container">
                    <div class="card-wetter">
                        <div class="card-body-wetter">
                            ...
                            <span id="sunrise" data-hour="{{ \Carbon\Carbon::parse($weather_data_widget['sunrise'])->format('H') }}"></span>
                            <span id="sunset" data-hour="{{ \Carbon\Carbon::parse($weather_data_widget['sunset'])->format('H') }}"></span>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    const now = new Date();
    const initialHour = now.getHours(); // Holt die aktuelle Stunde des Nutzers
