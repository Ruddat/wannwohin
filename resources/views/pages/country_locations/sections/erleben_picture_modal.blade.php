        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row"  style="min-height: 400px">
                    <div class="col-12">
                        <div style="background-repeat: no-repeat; background-size :cover;background-position :center;background-image: url('{{ asset("img/location_main_img/{$location->continent->alias}/{$location->country->alias}/klimatabelle-{$location->alias}.jpg") }}')" class="full-width h-100 figure-img img-fluid custom-border d-flex">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row"  style="min-height: 400px">
                    <div class="col-12">
                        <div style="background-repeat: no-repeat; background-size :cover;background-position :center;background-image: url('{{ asset("img/location_main_img/{$location->continent->alias}/{$location->country->alias}/klima-{$location->alias}.jpg") }}')" class="full-width h-100 figure-img img-fluid custom-border d-flex">
                            <div class="mt-auto ms-auto">
