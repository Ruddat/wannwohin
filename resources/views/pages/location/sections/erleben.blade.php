            ...
            <div class="col-3">
                    <div style="transform: rotate(345deg);width: max-content;position: relative;max-width: 300px;margin-left: 20px;top:20px">
                        <button class="border-0 p-0" data-bs-toggle="modal" data-bs-target="#erleben_picture1_modal">
                            <img src="{{ asset("img/location_main_img/{$location->continent->alias}/{$location->country->alias}/{$location->alias}/klimatabelle-{$location->alias}.webp") }}" class="figure-img img-fluid custom-border my-zoom" alt="" >
                        </button>
                    </div>
                    ...
                    <div style="position: relative;max-width: 300px;transform: rotate(355deg);width: max-content;margin-left: 20px;top:50px">
                        <button class="border-0 p-0" data-bs-toggle="modal" data-bs-target="#erleben_picture2_modal">
                            <img src="{{ asset("img/location_main_img/{$location->continent->alias}/{$location->country->alias}/{$location->alias}/klima-{$location->alias}.webp") }}" class="figure-img img-fluid custom-border my-zoom" alt="" >
                        </button>
                    </div>
            </div>
