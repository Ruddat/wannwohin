...
--}}
    ...
    @if (Route::is(
        ...
        @php
            ...
            $panoramaLocationText =
                session('headerData.headerContent.main_text') ?? ($panorama_location_text ?? 'Standardtext');
        @endphp
    ...
    @else
        <x-header-details :pic1-text="$pic1_text ?? 'Standardtext 1'" :pic2-text="$pic2_text ?? 'Standardtext 2'" :pic3-text="$pic3_text ?? 'Standardtext 3'" :head-line="$head_line ?? 'Standardüberschrift'" :gallery-images="$gallery_images ?? []" />
    @endif
