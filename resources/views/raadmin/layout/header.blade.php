                        ...
                        <div class="offcanvas offcanvas-end header-cart-canvas" tabindex="-1" id="cartcanvasRight"
                            ...
                            <div class="offcanvas-body app-scroll p-0">
                                <div class="head-container">
                                    <div class="head-box">
                                        <img src="{{asset('assets/ra-admin/images/ecommerce/19.jpg')}}" alt="cart" class="h-50 me-3 b-r-10">
                                ...
                                Pink</span>
                                    ...
                                    <div class="head-box">
                                        <img src="{{asset('assets/ra-admin/images/ecommerce/13.jpg')}}" alt="cart"
                                             class="h-50 object-fit-cover me-3 b-r-10">
                                        <div class="flex-grow-1">
                                            <a class="mb-0 f-w-600 f-s-16" href="#" target="_blank"> Women's Watch</a>
                                            <div>
                                                <i class="ti ti-star-filled text-warning f-s-12"></i>
                                                <i class="ti ti-star-filled text-warning f-s-12"></i>
                                                <i class="ti ti-star-filled text-warning f-s-12"></i>
                                ...
                                Gold</span>
                                    ...
                                    <div class="head-box">
                                        <img src="{{asset('assets/ra-admin/images/ecommerce/09.jpg')}}" alt="cart"
                                             class="h-50 object-fit-cover me-3 b-r-10">
                                        <div class="flex-grow-1">
                                ...
                                White</span>
                                    ...
                                    <div class="head-box ">
                                        <img src="{{asset('assets/ra-admin/images/ecommerce/23.jpg')}}" alt="cart"
                                             class="h-50 object-fit-cover me-3 b-r-10">
                                        <div class="flex-grow-1">
                                            <a class="mb-0 f-w-600 f-s-16" href="#" target="_blank"> Jackets</a>
                                            <div>
                                                <i class="ti ti-star-filled text-warning f-s-12"></i>
                                                <i class="ti ti-star-filled text-warning f-s-12"></i>
                                                <i class="ti ti-star-filled text-warning f-s-12"></i>
                                ...
                                Blue</span>
                                    ...
                                    <div class="head-box ">
                                        <img src="{{asset('assets/ra-admin/images/ecommerce/11.jpg')}}" alt="cart"
                                             class="h-50 object-fit-cover me-3 b-r-10">
                                        <div class="flex-grow-1">
                                ...
                                White</span>
                                    ...
                                    <div class="hidden-massage py-4 px-3">
                                        <img src="{{asset('assets/ra-admin/images/icons/cart.png')}}" alt="cart" class="w-50 h-50 mb-3">
                                        <div>
                                            <h6 class="mb-0">Your Cart is Empty</h6>
                                            <p class="text-secondary mb-0">Add some items :)</p>
                                            <a class="btn btn-light-primary btn-xs mt-2" href="#" target="_blank">Shop
                                                Now</a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="offcanvas offcanvas-end header-notification-canvas" tabindex="-1"
                            ...
                            <div class="offcanvas-body app-scroll p-0">
                              ...
                              <span class="bg-secondary h-35 w-35 d-flex-center b-r-10 position-relative">
                                <img src="{{asset('assets/ra-admin/images/ai_avtar/6.jpg')}}" alt="" class="img-fluid b-r-10">
                                <span
                              ...
                              <span class="bg-light-dark h-35 w-35 d-flex-center b-r-10 position-relative">
                                <i class="ph-duotone  ph-truck f-s-18"></i>
                                    ...
                                    <div class="notification-message head-box">
                                        <div class="message-images">
                              <span class="bg-secondary h-35 w-35 d-flex-center b-r-10 position-relative">
                                <img src="{{asset('assets/ra-admin/images/ai_avtar/2.jpg')}}" alt="" class="img-fluid b-r-10">
                                <span
                                    ...
                                    <div class="notification-message head-box">
                                        <div class="message-images">
                              <span class="bg-secondary h-35 w-35 d-flex-center b-r-10 position-relative">
                                <img src="{{asset('assets/ra-admin/images/ai_avtar/5.jpg')}}" alt="" class="img-fluid b-r-10">
                                <span
                                    class="position-absolute end-0 p-1 bg-secondary border border-light rounded-circle notification-avtar"></span>
                              </span>
                                        </div>
                                    ...
                                    <div class="notification-message head-box">
                                        <div class="message-images">
                              <span class="bg-secondary h-35 w-35 d-flex-center b-r-10 position-relative">
                                <img src="{{asset('assets/ra-admin/images/ai_avtar/1.jpg')}}" alt="" class="img-fluid b-r-10">
                                <span
                                    class="position-absolute  end-0 p-1 bg-secondary border border-light rounded-circle notification-avtar"></span>
                              </span>
                                        </div>
                                    ...
                                    <div class="hidden-massage py-4 px-3">
                                        <img src="{{asset('assets/ra-admin/images/icons/bell.png')}}" class="w-50 h-50 mb-3 mt-2" alt="">
                                        <div>
                    ...
                    <li class="header-profile">
                        <a href="#" class="d-block head-icon" role="button" data-bs-toggle="offcanvas"
                           data-bs-target="#profilecanvasRight" aria-controls="profilecanvasRight">
                            <img src="{{asset('assets/ra-admin/images/avtar/woman.jpg')}}" alt="avtar" class="b-r-10 h-35 w-35">
                        </a>
                        ...
                        <div class="offcanvas offcanvas-end header-profile-canvas" tabindex="-1" id="profilecanvasRight"
                            ...
                            <div class="offcanvas-body app-scroll">
                              ...
                              <span class="h-45 w-45 d-flex-center b-r-10 position-relative">
                                <img src="{{asset('assets/ra-admin/images/avtar/woman.jpg')}}" alt="" class="img-fluid b-r-10">
                              </span>
                                        </div>
                                  ...
                                  {{--
                                    ...
                                    <li>
                                        <div class="d-flex align-items-center justify-content-between">
                                            <a class="f-w-500" role="button" href="#" target="_blank" data-bs-toggle="dropdown"
                                               aria-expanded="false">
                                    ...
                                    <li>
                                        <div class="card card-light-primary upgrade-plan">
                                            <div class="card-body">
                                                <!-- <img src="{{asset('assets/ra-admin/images/header/01.png')}}" class="w-80" alt=""> -->
...
--}}
                                    ...
                                    <li>
                                        <form action="{{ route('verwaltung.logout') }}" method="POST">
                                            @csrf
                                            <button type="submit" class="nav-link btn btn-link mb-0 text-danger d-flex align-items-center" style="text-decoration: none;">
