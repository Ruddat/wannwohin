...
.header-section {
    position: relative;
    overflow: hidden;
    padding: 3rem 0; /* Standard-Padding für große Bildschirme */
}
...
@media (max-width: 576px) {
    ...
    .header-section .travel-heading { font-size: 1rem; }
    .header-section .travel-destination { font-size: 1.5rem; }
    .header-section .header-main-img { max-height: 200px; }
