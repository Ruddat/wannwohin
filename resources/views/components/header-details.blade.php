    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 col-xl-5">
                <span class="custom-header-text">{!! $headLine ?? '<h1>Default Header Text</h1>' !!}</span>
            </div>
            <!-- Scroll-Icon -->
...
@media (min-width: 768px) { /* Für mittlere Bildschirme */
    .pic3-image {
        height: 400px;
    }
    .custom-header-section .custom-header-text {
...
@media (min-width: 1200px) { /* Für große Bildschirme */
    .pic3-image {
        height: 500px;
    }
}
