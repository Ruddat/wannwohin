...
<li>
    ...
    <style>
        /* Parallax-Effekt */
/* Parallax-Effekt – FIXED VERSION */
.custom-header-section {
    position: relative;
    overflow: hidden;
    padding: 2rem 0;
    min-height: 480px; /* FIX: Parallax kann Section nicht mehr zusammenschieben */
}
...
.parallax-background {
    ...
    left: 0;
    width: 100%;
    height: 130%; /* FIX: größer als die Section, verhindert sichtbares Verschieben */
...
.inner-shape {
    position: relative;
    z-index: 10; /* FIX: bleibt immer oben, unabhängig von Parallax */
}
