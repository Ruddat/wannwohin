                                ...
                                <div class="row">
                                    ...
                                    <div class="row p-0 m-0">
                                        ...
                                        <div class="col-md-5">
                                            ...
                                            <span class="px-1 custom-text-color-2"><a class="custom-text-color-2" href="{{  route('location', ['continent' => $location->continent_alias, 'country' => $location->country_alias, 'location' => $location->location_alias])   }}">{{$location->title}}</a></span>
                                        </div>
                                        <div class="col-md-2">
