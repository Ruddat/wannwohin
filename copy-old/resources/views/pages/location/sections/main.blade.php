<section class="section section-no-border bg-color-light m-0 pb-0" style="background-color: #eaeff5 !important;">
    <div class="container" style="background-color: #eaeff5">
        <div class="row">
            <div class="col-7">
                <div style="background-repeat: no-repeat; background-size :cover;background-position :center;background-image: url('{{ asset("img/location_main_img/{$location->continent->alias}/{$location->country->alias}/{$location->alias}/beste-reisezeit-{$location->alias}.jpg") }}')"
...
{{--                                    <span>Optimize </span>--}}
                            ...
                            <tr>
                                <td>
                                    <span>zeitverschiebung</span>
                                        <div><h5 class="m-0">{{$location_time_diff}} {{ abs($location_time_diff)> 1 ? 'Stunden' : 'Stunde' }}</h5></div>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <a href="#" class="text-color-primary" data-bs-toggle="tooltip" data-bs-animation="false" title="" data-bs-original-title="Zur Berechnung vergleichen wir das durchschnittliche pro Kopf Einkommen der verschiedenen Länder mit Deutschland"><i class="fa fa-question-circle"></i></a>
...
{{--                                    <div><h5 class="m-0">{{ $location->country->electric->power }}</h5></div>--}}
                ...
                {{--Price of location--}}
                <div class="row bg-white py-3 my-2 text-center box-shadow-2" style="margin-right: 0.10rem!important; margin-left: 0.10rem!important;">
