<div id="main">
        <x-header :bg-img="asset('assets/img/pages/main/about-me-bg-3.jpg')" :main-img="asset('assets/img/pages/main/me.jpg')"></x-header>
                ...
                <div class="row justify-content-end">
                    <div class="col-lg-3 text-center custom-xs-border-bottom p-0">
                        ...
                        <span class="custom-nav-button text-color-dark">
                            <i class="icon-earphones-alt icons text-color-primary"></i> Reisebericht senden
                        </span>
                        </a>
                    </div>
